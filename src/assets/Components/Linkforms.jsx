...
// //     height: "600px",
// //   };
// //   const { socialLinks, userImage, userFirstName, userLastName, userGmail } =
// //     useUser();
...
// //         <div className="flex flex-col items-center w-[500px] bg-white sticky top-0">
// //           <div className="flex flex-col items-center">
// //             <div style={backgroundImgStyle} className="mt-10 ">
...
// //                 <p className="text-black text-center items-center text-2xl font-[600]">
// //                   {userFirstName}
// //                 </p>
// //                 <p className="text-black text-center items-center text-2xl font-[600]">
// //                   {userLastName}
// //                 </p>
// //               </div>
// //               <p className="text-black text-center text-1xl font-[100]">
// //                 {userGmail}
// //               </p>
// //               <div className="flex justify-between gap-2 w-[250px] mx-auto h-[200px] mt-[90px] flex-wrap ">
...
// //                       className="flex items-center justify-between gap-1 w-full rounded cursor-pointer h-[50px] p-2"
// //                     >
...
// //         <button className=" fixed right-[100px]  top-[50px] text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" onClick={() => setGoNext(!goNext)}>{!goNext ? 'Go Next' : 'Go Back'}</button>
// //       </div>
...
//       <div className="flex justify-center w-full">
//         <button
//           className="fixed right-[100px] top-[50px] text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
  ...
  return (
    <>
              ...
              <div className="flex justify-between  w-[250px] mx-auto h-[200px] mt-[80px]  flex-wrap">
                {socialLinks.map((link, index) => (
                  ...
                  >
                    <div
                      style={{ backgroundColor: getBackgroundColor(link.type) }}
                      className="flex items-center justify-between gap-1 w-[200px]  mx-auto rounded cursor-pointer h-[50px] p-2"
                    >
                      <p className="flex items-center text-white">
                        {socialMediaIcons[link.type]} {link.type.toUpperCase()}
                      </p>
      ...
      {/* <div className="flex justify-center w-full mt-4 lg:mt-0">
        <button
          className="fixed lg:relative right-[20px] lg:right-[100px] top-[20px] lg:top-[50px] text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
          onClick={() => setGoNext(!goNext)}
        >
          {!goNext ? "Go Next" : "Go Back"}
        </button>
